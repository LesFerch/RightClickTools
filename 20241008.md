...
1. Download **RightClickTools-Setup.exe** using the link above.
...
The checkboxes in the Right-Click Tools dialogs can be configured to use one of two different styles. Edit the file **RightClickTools.ini** and change **AlternatCheckbox=0** to  **AlternatCheckbox=1** to change the style. Below is an example of the difference in Windows 10 dark mode:
